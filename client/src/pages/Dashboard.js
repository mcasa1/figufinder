    ...
    return (
        ...
        {user &&
            <div className="dashboard">
                ...
                <h3>Gracias por estar usando la herramienta! Queria avisarte que por ser una herramienta gratis esta tiene sus limitaciones. Es por esto que para que la app te funcione la cantidad de figuritas que se pueden cargar por persona son 200, entre tus repetidas y las que necesitas hasta que pueda encontrar una mejor solución. Espero que igualmente asi te sirva!</h3>
